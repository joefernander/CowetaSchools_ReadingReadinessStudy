...
ranked_df |> 
  ...
  gt() |> 
  tab_header(
    title = "Elementary School Performance Analysis"
  ) |> 
  tab_spanner(
    label = md("**Annual Scores**"),
    columns = 2:8,
    id = "annual"
  ) |> 
  tab_spanner(
  ...
  tab_footnote(
    footnote = "Percentage of students meeting or exceeding standards on state assessments",
    locations = cells_column_spanners(spanners = "annual")
  ) |> 
  tab_footnote(
    footnote = "Percentage point change from baseline year to 2025. COVID Gap shows change from 2019 to 2021.",
    locations = cells_column_spanners(spanners = "change")
  ) |> 
  tab_footnote(
    footnote = "Performance change during COVID-19 pandemic (2019 to 2021)",
